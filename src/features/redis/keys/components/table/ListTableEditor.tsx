          ...
          <div className="flex flex-col gap-2">
            ...
            {rows.map((row, index) => (
              ...
              >
                ...
                <Input
                  className="flex-1 border-0 bg-transparent p-0 font-mono text-xs text-slate-200 focus:ring-0"
                  value={row.value}
            ...
            <button
              className="mt-2 flex items-center gap-1 rounded-md border border-action/40 bg-action/10 px-2 py-1 text-xs font-semibold text-action transition hover:border-action/70 hover:bg-action/20"
              type="button"
              onClick={onAdd}
            >
